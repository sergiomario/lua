...
O ambiente associado a uma função em C pode ser diretamente acessado pelo código fonte C. Isso é usado como o ambiente padrão para outras funções C e objetos \textbf{userdata} criados pela função.
